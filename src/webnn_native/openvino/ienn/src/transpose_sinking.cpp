...
/*
 * This file is originated from this
 * repo-https://github.com/openvinotoolkit/openvino_tensorflow/blob/master/openvino_tensorflow/pass/transpose_sinking.cc
 * commit id: 5c8f0130d3bbac4485476b612b26edec4e81f339
 */
using namespace std;
