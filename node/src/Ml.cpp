...
Napi::Value ML::GetNeuralNetworkContext(const Napi::CallbackInfo& info) {
    Napi::Object context = NeuralNetworkContext::constructor.New({info.This().As<Napi::Value>()});
...
Napi::Object ML::Initialize(Napi::Env env, Napi::Object exports) {
    ...
    Napi::Function func = DefineClass(
        env, "ml",
        {StaticMethod("getNeuralNetworkContext", &ML::GetNeuralNetworkContext, napi_enumerable)});
